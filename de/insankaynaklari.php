                                    ...
                                    <div class="about-box8">
                                        ...
                                        <div class="media">
                                            <ul class="about-list" style="margin-bottom:30px;">
                                                <li style="color: #495057; font-size:18px;"><i class="fas fa-check"></i>Sie können Ihre Lebensläufe an kariyer@istanbulteknik.com senden,</li>
                                                <li style="color: #495057;font-size:18px;"><i class="fas fa-check"></i>Unsere Stellenausschreibungen finden Sie unter www.kariyer.net</li>
