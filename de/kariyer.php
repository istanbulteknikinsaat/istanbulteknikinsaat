                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="about-box8">
                                        ...
                                        <p>İstanbul Teknik Ailesi’nin bir üyesi olmak için;</p>
                                        <div class="media">
                                            <ul class="about-list">
                                                <li><i class="fas fa-check"></i>kariyer@istanbulteknik.com ‘a özgeçmişlerinizi gönderebilir,</li>
                                                <li><i class="fas fa-check"></i>www.kariyer.net  adresinden iş ilanlarımızı inceleyebilirsiniz.</li>
