                ...
                <ul class="first-ul">
                  ...
                  <li> <a class="aboutbtn" style="cursor: context-menu">Kurumsal</a>
                    <ul>
                      ...
                      <li><a href="/<?php echo $urlend;?>/vizyonmisyon.php">Vizyonumuz & Misyonumuz</a></li>
                  ...
                  <li><a class="productsbtn">Ürünler</a>
                  <?php
                  ...
                  <li style="display: block; width:50px;">
                    <img style="display:inline-block; width: 100%;" src="/tr/images/blue.png" alt=""><a
