        ...
        <div class="full">
          <div class="title-holder">
            <div class="title-holder-cell text-left">
              <h1 class="page-title">İstanbul Teknikliler</h1>
              <ol class="breadcrumb">
                <li><a href="index.php">Anasayfa</a></li>
                <li class="active">Hakkımızda</li>
                <li class="active">İstanbul Teknikliler</li>
              </ol>
            </div>
          </div>
        </div>
...
<div class="section padding_layout_1">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <div class="full">
          <div id="main_xtext" class="main_heading text_align_center">
          <section class="istanbul-teknik-team">
              <h2>İstanbul Teknikliler</h2>
                <p class="large"><?php 
              $sql = "SELECT icerik FROM kurumsal_yazilar WHERE dil='$lang' and siralama='5'";
