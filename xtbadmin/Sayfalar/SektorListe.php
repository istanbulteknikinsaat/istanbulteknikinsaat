        ...
        <div class="col-md-12">
          <div class="box box-success">
            <div class="box-header">
              <h3 class="box-title">Sektör Liste 
              </h3>
              <!-- tools box -->
            ...
            <div class="box-body">
			   <div class="row">
				<div class="col-md-12">
					<div class="col-sm-2">
						<a href ="SektorEkle.php" ><button  class="btn btn-block btn-success">Ekle</button></a><br />
					</div>
                  ...
                  <table id="Tablo" class="table table-bordered table-hover table-striped">
                    ...
                    <thead>
                      <tr>
                        ...
                        <th>Sektör AdıEN</th>
                        <th>Sektör AdıDE</th>
                        <th>Sektör Açıklaması</th>
                        <th>Sektör AçıklamasıEN</th>
                        <th>Sektör AçıklamasıDE</th>
                        <th>Sektör Resim</th>
                        <th>İlişkili Uygulamalar</th>
...
<?php   require_once 'SayfaAlt.php'; 
	...
	<script>
      ...
      function SonucListele() {
          $("#SonucListe").empty();
		  $("#SonucListe").load("ajax/Liste/SektorListe.php", function (cevap,durum) {
			  if(durum =="success")
				{
      ...
      function SatirSet(e) {
        ...
        ID =   SayiTemizle(ID);
        window.location.href =("SektorEkle.php?islem=Duzenle&ID="+ID);
      }
      ...
      $(function() {
        ...
        {
          window.location.href=("SektorEkle.php?islem=Duzenle&ID="+TiklanilanID);
        });
