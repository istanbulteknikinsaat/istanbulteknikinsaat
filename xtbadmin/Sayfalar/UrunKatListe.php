        ...
        <div class="col-md-12">
          <div class="box box-success">
            <div class="box-header">
              <h3 class="box-title">Ürünler Kategori Liste 
              </h3>
              <!-- tools box -->
            ...
            <div class="box-body">
			   <div class="row">
				<div class="col-md-12">
					<div class="col-sm-2">
						<a href ="UrunKatEkle.php" ><button  class="btn btn-block btn-success">Ekle</button></a><br />
					</div>
...
window.onload = function() {
  ...
  function anakat(){
    $("#showCatInfo").empty();
		  $("#showCatInfo").load("ajax/Liste/UrunKatListeKategoriBilgisi.php", function (cevap,durum) {
			  if(durum =="success")
				{
                    $("#showCatInfo").empty();
  ...
  function altkat(){
    $("#showSubCatInfo").empty();
		  $("#showSubCatInfo").load("ajax/Liste/UrunKatListeAltKategoriBilgisi.php", function (cevap,durum) {
			  if(durum =="success")
				{
                    $("#showSubCatInfo").empty();
                    cevap=jQuery.parseJSON(cevap);
      ...
      function SonucListele() {
          $("#SonucListe").empty();
		  $("#SonucListe").load("ajax/Liste/UrunKatListe.php", function (cevap,durum) {
			  if(durum =="success")
				{
				  cevap=jQuery.parseJSON(cevap);
                  $("#SonucListe").empty();
      ...
      function SatirSet(e) {
        ...
        ID =   SayiTemizle(ID);
        window.location.href =("UrunKatEkle.php?islem=Duzenle&ID="+ID);
      }
      ...
      $(function() {
        ...
        {
          window.location.href=("UrunKatEkle.php?islem=Duzenle&ID="+TiklanilanID);
        });
      ...
      function AramaIslemi(){
          ...
          if($("#TxtArama").val().length<=0)
          {
              ...
              PostRequest= $.post("ajax/Liste/UrunKatListe.php",{Like:$("#TxtArama").val()},function (cevap) {
				  cevap=jQuery.parseJSON(cevap);
                  $("#SonucListe").empty();
                  $("#SonucListe").prepend(cevap.ok);
				  $("#ListeToplamKalan").empty();
