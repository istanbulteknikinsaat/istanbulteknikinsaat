...
if(OturumAktif()==true)
{
	...
	if($_GET)
	{
		 if ($_SERVER['REQUEST_METHOD'] === 'GET') 
		 {
			...
			{
				$ID=$_GET['ID'];
				$Query=$db->prepare("SELECT * FROM haberler WHERE IsActive=1 AND ID=?");
        ...
        <div class="col-md-12">
          <div class="box box-success">
            <div class="box-header">
              <h3 class="box-title">Haber/Duyuru Ekle
              </h3>
              <!-- tools box -->
                        ...
                        <div class="col-xs-12">
						    <div class="col-md-6">
                             <div class="form-group" >
									...
									<div class="col-sm-8">
										<select id="kategoriAdi" type="text"
											name="kategoriAdi" class="form-control input-sm">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-4 control-label">Haber Adı</label>
                                    <div class="col-sm-8">
                                        <input type="text" name="HaberAdi"
                                            class="form-control input-sm "
                                            value="<?= $HaberAdi ?>"
                                            placeholder="<?= $HaberAdi ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                            <label class="col-sm-4 control-label">Haber Aciklama</label>
                                            <div class="col-sm-8">
                                                <textarea class="ckeditor" id="HaberAciklamasiCK"
                                                    name="HaberAciklama"><?= $HaberAciklama ?></textarea>
                                            </div>
                                        </div>
                                        <!-- <div class="form-group">
                                    <label class="col-sm-4 control-label">Haber Slug</label>
                                    <div class="col-sm-8">
                                        <input type="text" name="HaberSlug"
                                            class="form-control input-sm "
                                            value="<?= $SliderAdi ?>"
                                        ...
                                        <div class="col-sm-8">
                                            <select id="lang" type="text" name="lang" value="" class="form-control input-sm">
                                                ...
                                                while($row=$sql->fetch(PDO::FETCH_ASSOC)) {                                              
                                                    ?>
                                                <option  <?php if($row['slug']==$Row['lang']){echo "selected";
							...
							<div class="col-md-6">
								<div class="form-group" >
									<label class="col-sm-4 control-label">Görsel Ekle </label>
									<div class="col-sm-6">
...
if(ResimAdi){
	$("#ResimFiles").append('<img src="/images/haberler/'+ResimAdi+'"  width="100px"  >');
}

<?php } ?>	
CKEDITOR.replace('HaberAciklamasiCK');
                                ...
                                if (hatavar) {
                                    ...
                                    BootstrapDialog.show({
                                        ...
                                        onhidden: function (dialogRef) {
                                            window.location="HaberListe.php";
                                        }
                                    });
                                }
                            },
		...
		$("#Duzenle").click(function(){
            for (var HaberAciklamasiCK in CKEDITOR.instances)
		        CKEDITOR.instances[HaberAciklamasiCK].updateElement();
			Form1Guncelle();
		});		
...
$(function () {
    ...
    var url = 'ajax/HaberUpload/index.php',
        uploadButton = $('<label/>')
