        ...
        <div class="col-md-12">
          <div class="box box-success">
            <div class="box-header">
              <h3 class="box-title">Yasal Uyari</h3>
              <!-- tools box -->
            ...
            <div class="box-body">
			   <div class="row">
				<div class="col-md-12">
					<div class="col-sm-2">
						<a href ="YasalUyariEkle.php" ><button  class="btn btn-block btn-success">Ekle</button></a><br />
          </div>
...
function SonucListele() {
  $("#SonucListe").empty();
$("#SonucListe").load("ajax/Liste/YasalUyariListe.php", function (cevap,durum) {
if(durum =="success")
{
...
{
  window.location.href=("YasalUyariEkle.php?islem=Duzenle&ID="+TiklanilanID);
});
$("#SilMenu").click(function()
{
  ...
  if (result) {
    ...
    $.ajax({
      url: "ajax/Sil/YasalUyariSil.php",
      dataType: "JSON",
      type: "POST",
...
function AramaIslemi(){
  ...
  if($("#TxtArama").val().length<=0)
  {
      ...
      PostRequest= $.post("ajax/Liste/YasalUyariListe.php",{Like:$("#TxtArama").val()},function (cevap) {
  cevap=jQuery.parseJSON(cevap);
          $("#SonucListe").empty();
          $("#SonucListe").prepend(cevap.ok);
  $("#ListeToplamKalan").empty();
