        ...
        <div class="col-md-12">
          <div class="box box-success">
            <div class="box-header">
              <h3 class="box-title">Bayi Başvuru Formu</h3>
              <!-- tools box -->
                  ...
                  <table id="Tablo" class="table table-bordered table-hover table-striped">
                    <thead>
                      <tr>
                        ...
                        <th>E-Mail</th>
                        <th>Fax</th>
                        <th>Firma Web Adresi</th>
                        <th>Vergi Dairesi No</th>
                        <th>Tic. Sic. No:</th>
                        <th>Önceki Yıl Cirosu</th>
                        <th>Toplam Personel Sayısı</th>
                        <th>Aktif Olarak Satış Yapılan İller</th>
                        <th>Tarih</th>
...
function SonucListele() {
  $("#SonucListe").empty();
$("#SonucListe").load("ajax/Liste/BayiBasvuruListe.php", function (cevap,durum) {
if(durum =="success")
{
...
function AramaIslemi(){
  ...
  if($("#TxtArama").val().length<=0)
  {
      ...
      if(PostRequest!=undefined)
      {
          ...
          PostRequest= $.post("ajax/Liste/BayiBasvuruListe.php",{Like:$("#TxtArama").val()},function (cevap) {
          cevap=jQuery.parseJSON(cevap);
          $("#SonucListe").empty();
          $("#SonucListe").prepend(cevap.ok);
          $("#ListeToplamKalan").empty();
