  ...
  <div class="content-wrapper">
        ...
        <div class="col-md-12">
          <div class="box box-success">
            <div class="box-header">
              <h3 class="box-title">Resimler Liste 
              </h3>
              <!-- tools box -->
            ...
            <div class="box-body">
			   <div class="row">
				<div class="col-md-12">
					<div class="col-sm-2">
						<a href ="ResimEkle.php" ><button  class="btn btn-block btn-success">Ekle</button></a><br />
					</div>
	...
	<script>
      ...
      function SonucListele() {
          $("#SonucListe").empty();
		  $("#SonucListe").load("ajax/Liste/ResimListe.php", function (cevap,durum) {
			  if(durum =="success")
				{
      ...
      $(function() {
        ...
        {
          window.location.href=("ResimEkle.php?islem=Duzenle&ID="+TiklanilanID);
        });
      ...
      var PostRequest;
          ...
          if($("#TxtArama").val().length<=0)
          {
              ...
              if(PostRequest!=undefined)
              {
                  ...
                  PostRequest= $.post("ajax/Liste/ResimListe.php",{Like:$("#TxtArama").val()},function (cevap) {
				          cevap=jQuery.parseJSON(cevap);
                  $("#SonucListe").empty();
                  $("#SonucListe").prepend(cevap.ok);
				          $("#ListeToplamKalan").empty();
