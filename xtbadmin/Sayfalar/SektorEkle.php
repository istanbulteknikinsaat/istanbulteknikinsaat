...
if(OturumAktif()==true)
{
	...
	if($_GET)
	{
		 if ($_SERVER['REQUEST_METHOD'] === 'GET') 
		 {
			...
			{
				$ID=$_GET['ID'];
				$Query=$db->prepare("SELECT * FROM sektorler WHERE id=?");
            ...
            <div class="col-md-12">
                <div class="box box-success">
                    <div class="box-header">
                        <h3 class="box-title">Sektör Ekle
                        </h3>
                        <!-- tools box -->
                                ...
                                <div class="col-xs-12">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label">Sektör Adı</label>
                                            <div class="col-sm-8">
                                                <input type="text" name="SektorAdi" class="form-control input-sm "
                                                    value="<?= $SektorAdi ?>" placeholder="<?= $SektorAdi ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label">Sektör Adı EN</label>
                                            <div class="col-sm-8">
                                                <input type="text" name="SektorAdiEN" class="form-control input-sm "
                                                    value="<?= $SektorAdiEN ?>" placeholder="<?= $SektorAdiEN ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label">Sektör Adı DE</label>
                                            <div class="col-sm-8">
                                                <input type="text" name="SektorAdiDE" class="form-control input-sm "
                                                    value="<?= $SektorAdiDE ?>" placeholder="<?= $SektorAdiDE ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label">Sektör Aciklama</label>
                                            <div class="col-sm-8">
                                                <textarea class="ckeditor" id="SektorAciklamasiCK"
                                                    name="SektorAciklama"><?= $SektorAciklama ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label">Sektör Aciklama EN</label>
                                            <div class="col-sm-8">
                                                <textarea class="ckeditor" id="SektorAciklamasiENCK"
                                                    name="SektorAciklamaEN"><?= $SektorAciklamaEN ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label">Sektör Aciklama DE</label>
                                            <div class="col-sm-8">
                                                <textarea class="ckeditor" id="SektorAciklamasiDECK"
                                                    name="SektorAciklamaDE"><?= $SektorAciklamaDE ?></textarea>
                                            </div>
                                        </div>
                                        <!-- <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label">Sektör Resmi </label>
                                            <div class="col-sm-6">
                                                <label id="ResimSec"
...
ResimAdi="<?=$SektorResim?>";	
console.log(ResimAdi);
if(ResimAdi){
	$("#ResimFiles").append('<img src="/images/sektorler/'+ResimAdi+'"  width="100px"  >');
}
    
    CKEDITOR.replace('SektorAciklamasiCK');
    CKEDITOR.replace('SektorAciklamasiENCK');
    CKEDITOR.replace('SektorAciklamasiDECK');


    function Form1Kaydet() {
        var Form1 = document.getElementById('Form1');
        if (Form1.SektorAciklama.value == "") {
                ...
                if (hatavar) {
                    ...
                    BootstrapDialog.show({
                        ...
                        onhidden: function (dialogRef) {
                            window.location = "SektorListe.php";
                        }
                    });
                }
            },
    ...
    $("#Kaydet").click(function () {
        for (var SektorAciklamasiCK in CKEDITOR.instances)
		CKEDITOR.instances[SektorAciklamasiCK].updateElement();
        for (var SektorAciklamasiENCK in CKEDITOR.instances)
        CKEDITOR.instances[SektorAciklamasiENCK].updateElement();
        for (var SektorAciklamasiDECK in CKEDITOR.instances)
        CKEDITOR.instances[SektorAciklamasiDECK].updateElement();
        Form1Kaydet();
    });
    ...
    $(function () {
        ...
        var url = 'ajax/SektorUpload/index.php',
            uploadButton = $('<label/>')
