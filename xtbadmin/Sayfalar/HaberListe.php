        ...
        <div class="col-md-12">
          <div class="box box-success">
            <div class="box-header">
              <h3 class="box-title">Haber Liste 
              </h3>
              <!-- tools box -->
            ...
            <div class="box-body">
			   <div class="row">
				<div class="col-md-12">
					<div class="col-sm-2">
						<a href ="HaberEkle.php" ><button  class="btn btn-block btn-success">Ekle</button></a><br />
					</div>
...
<?php   require_once 'SayfaAlt.php'; 
	...
	<script>
      ...
      function SonucListele() {
          $("#SonucListe").empty();
		  $("#SonucListe").load("ajax/Liste/HaberListe.php", function (cevap,durum) {
			  if(durum =="success")
				{
      ...
      function SatirSet(e) {
        ...
        ID =   SayiTemizle(ID);
        window.location.href =("HaberEkle.php?islem=Duzenle&ID="+ID);
      }
      ...
      $(function() {
        ...
        {
          window.location.href=("HaberEkle.php?islem=Duzenle&ID="+TiklanilanID);
        });
      ...
      function AramaIslemi(){
          ...
          if($("#TxtArama").val().length<=0)
          {
              ...
              PostRequest= $.post("ajax/Liste/HaberListe.php",{Like:$("#TxtArama").val()},function (cevap) {
				  cevap=jQuery.parseJSON(cevap);
                  $("#SonucListe").empty();
                  $("#SonucListe").prepend(cevap.ok);
				  $("#ListeToplamKalan").empty();
