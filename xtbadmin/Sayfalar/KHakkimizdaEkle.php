...
if(OturumAktif()==true)
{
    ...
    if($_GET)
	{
		 if ($_SERVER['REQUEST_METHOD'] === 'GET') 
		 {
			...
			{ 
                $ID=$_GET['ID'];
				$Query=$db->prepare("SELECT * FROM pagehakkimizda WHERE ID=$ID");
            ...
            <div class="col-md-12">
                <div class="box box-success">
                    <div class="box-header">
                        <h3 class="box-title">Hakkımızda Sayfa Ekle
                        </h3>
                        <!-- tools box -->
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label">Sayfa Başlık 2</label>
                                            <div class="col-sm-8">
                                                <input type="text" name="SayfaBaslikAlt" class="form-control input-sm "
                                                    value="<?= $SayfaBaslikAlt ?>" placeholder="<?= $SayfaBaslikAlt ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label">Sayfa Açıklama Alt</label>
                                            <div class="col-sm-8">
                                                <textarea class="ckeditor" id="SayfaAciklamaAltCK"
                                                    name="SayfaAciklamaAlt"><?= $SayfaAciklamaAlt ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label">Bayi Resim </label>
                                            <div class="col-sm-6">
                                                <label id="ResimSec"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label">Deneyim Resim </label>
                                            <div class="col-sm-6">
                                                <label id="ResimSec"
                                                    class="btn btn-success btn-block btn-sm fileinput-button">
                                                    <i class="glyphicon glyphicon-plus"></i>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label">Sermaye Resim </label>
                                            <div class="col-sm-6">
                                                <label id="ResimSec"
                                                    class="btn btn-success btn-block btn-sm fileinput-button">
                                                    <i class="glyphicon glyphicon-plus"></i>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label">İhracat Resim </label>
                                            <div class="col-sm-6">
                                                <label id="ResimSec"
                                                    class="btn btn-success btn-block btn-sm fileinput-button">
                                                    <i class="glyphicon glyphicon-plus"></i>
                                                    <span>Resim Seç...</span>
                                                    <input id="SayfaResimİhracat" type="file" name="files[]" value="<?= $SayfaResimİhracat ?>" style="display: none;"
                                                        multiple>
                                                    <input id="SayfaResimİhracatAdi"  name="SayfaResimİhracat" value="<?= $SayfaResimİhracat ?>" style="display:none">
                                                </label>
                                                <br>
                                                <br>
                                                <div id="ResimProgress4" class="progress">
                                                    <div class="progress-bar progress-bar-success"></div>
                                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label">Kıta Resim </label>
                                            <div class="col-sm-6">
                                                <label id="ResimSec"
                                                    class="btn btn-success btn-block btn-sm fileinput-button">
                                                    <i class="glyphicon glyphicon-plus"></i>
                                                    <span>Resim Seç...</span>
                                                    <input id="SayfaResimKıta" type="file" name="files[]" value="<?= $SayfaResimKıta ?>" style="display: none;"
                                                        multiple>
                                                    <input id="SayfaResimKıtaAdi"  name="SayfaResimKıta" value="<?= $SayfaResimKıta ?>" style="display:none">
                                                </label>
                                                <br>
                                                <br>
                                                <div id="ResimProgress5" class="progress">
                                                    <div class="progress-bar progress-bar-success"></div>
                                                </div>
...
if(SayfaResimİhracatAdi){
	$("#ResimFiles4").append('<img src="/images/kurumsal/'+SayfaResimİhracatAdi+'"  width="100px"  >');
}
if(SayfaResimKıtaAdi){
	$("#ResimFiles5").append('<img src="/images/kurumsal/'+SayfaResimKıtaAdi+'"  width="100px"  >');
}
function Form1Kaydet() {
                    ...
                    $.ajax(
                        {
                            url: "ajax/Kayit/KHakkimizdaEkle.php",
                            type: "POST",
                            dataType: "JSON",
                                ...
                                if (hatavar) {
                                    ...
                                    BootstrapDialog.show({
                                        ...
                                        onhidden: function (dialogRef) {
                                            window.location="KHakkimizdaListe.php";
                                        }
                                    });
                                }
                            },
        ...
        var url = 'ajax/KHakkimizdaUpload/index.php',
            ...
            .parent().addClass($.support.fileInput ? undefined : 'disabled');
             ...
             $('#SayfaResimİhracat').fileupload({
                ...
                var progress = parseInt(data.loaded / data.total * 100, 10);
                $('#ResimProgress4 .progress-bar').css(
                    'width',
                    progress + '%'
                );
            }).on('fileuploaddone', function (e, data) {
                $.each(data.result.files, function (index, file) {
                    SayfaResimİhracatAdi = file.name;
                    ResimLink = file.url;
                    $("#SayfaResimİhracatAdi").val(SayfaResimİhracatAdi);
                    if (file.url) {
                        var link = $('<a>')
                            .attr('target', '_blank')
                            .prop('href', file.url);
            ...
            $('#SayfaResimKıta').fileupload({
                ...
                var progress = parseInt(data.loaded / data.total * 100, 10);
                $('#ResimProgress5 .progress-bar').css(
                    'width',
                    progress + '%'
                );
            }).on('fileuploaddone', function (e, data) {
                $.each(data.result.files, function (index, file) {
                    SayfaResimKıtaAdi = file.name;
                    ResimLink = file.url;
                    $("#SayfaResimKıtaAdi").val(SayfaResimKıtaAdi);
                    if (file.url) {
                        var link = $('<a>')
                            .attr('target', '_blank')
                            .prop('href', file.url);
