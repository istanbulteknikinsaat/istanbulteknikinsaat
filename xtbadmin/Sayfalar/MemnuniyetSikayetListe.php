        ...
        <div class="col-md-12">
          <div class="box box-success">
            <div class="box-header">
              <h3 class="box-title">Memnuniyet Şikayet Formu</h3>
              <!-- tools box -->
                  ...
                  <table id="Tablo" class="table table-bordered table-hover table-striped">
                    <thead>
                      <tr>
                        ...
                        <th>E-mail</th>
                        <th>Telefon</th>
                        <th>Memnuniyet/Şikayet Konusu</th>
                        <th>Mesaj</th>
                        <th>Tarih</th>
...
function SonucListele() {
  $("#SonucListe").empty();
$("#SonucListe").load("ajax/Liste/MemnuniyetSikayetListe.php", function (cevap,durum) {
if(durum =="success")
{
...
function AramaIslemi(){
  ...
  if($("#TxtArama").val().length<=0)
  {
      ...
      if(PostRequest!=undefined)
      {
          ...
          PostRequest= $.post("ajax/Liste/MemnuniyetSikayetListe.php",{Like:$("#TxtArama").val()},function (cevap) {
          cevap=jQuery.parseJSON(cevap);
          $("#SonucListe").empty();
          $("#SonucListe").prepend(cevap.ok);
          $("#ListeToplamKalan").empty();
