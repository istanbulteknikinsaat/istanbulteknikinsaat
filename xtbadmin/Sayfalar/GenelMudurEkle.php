...
if(OturumAktif()==true)
{
    ...
    if($_GET)
	{
		 if ($_SERVER['REQUEST_METHOD'] === 'GET') 
		 {
			...
			{
                $ID=$_GET['ID'];
				$Query=$db->prepare("SELECT * FROM pagegenelmudur WHERE ID=$ID");
            ...
            <div class="col-md-12">
                <div class="box box-success">
                    <div class="box-header">
                        <h3 class="box-title">Genel Müdür Mesajı Sayfası
                        </h3>
                        <!-- tools box -->
...
if(SayfaResimAdi){
	$("#ResimFiles").append('<img src="/images/kurumsal/'+SayfaResimAdi+'"  width="100px"  >');
}
            function Form1Kaydet() {
                    ...
                    $.ajax(
                        {
                            url: "ajax/Kayit/GenelMudurEkle.php",
                            type: "POST",
                            dataType: "JSON",
                                ...
                                if (hatavar) {
                                    ...
                                    BootstrapDialog.show({
                                        ...
                                        onhidden: function (dialogRef) {
                                            window.location="GenelMudurListe.php";
                                        }
                                    });
                                }
                            },
