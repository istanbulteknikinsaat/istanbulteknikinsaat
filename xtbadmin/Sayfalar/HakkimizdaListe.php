      ...
      <div class="col-md-12">
        <div class="box box-success">
          <div class="box-header">
            <h3 class="box-title">Hakkimizda Yazilari Listesi
            </h3>
            <!-- tools box -->
            <div class="pull-right box-tools">
              <button type="button" class="btn bg-green btn-sm" data-widget="collapse" data-toggle="tooltip"
                title="Gizle">
          ...
          <div class="box-body">
            <div class="row">
              <div class="col-md-12">
                <div class="col-sm-2">
                  <a href="HakkimizdaEkle.php"><button class="btn btn-block btn-success">Ekle</button></a><br />
                </div>
        ...
        <!-- /.box -->
        <div style="border: 1px solid #000" class="col-sm-3  pull-left">
                <h4 style="font-weight: bold">Dil</h4>
                    <p>1 - Turkce</p>
                    <p>2 - Ingilizce</p>
                    <p>3 - Almanca</p>
                    <p>4 - Fransizca</p>
                ...
                <div style="border: 1px solid #000" class="col-sm-3  pull-right">
                <h4 style="font-weight: bold">Siralama</h4>
                    <p>1 - Kalite Politikamiz</p>
                    <p>2 - Vizyonumuz & Misyonumuz</p>
                    <p>3 - Ilkelerimiz</p>
                    <p>4 - Tarihcemiz</p>
                    <p>5 - Istanbul Teknikliler</p>
                    <p>6 - Arge</p>
                    <p>7 - Hakkımızda</p>
                </div>
      </div>
...
<div id="contextMenu" class="dropdown clearfix">
  <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu"
    style="display:block;position:static;margin-bottom:5px; border-color: #08ae66">
...
<script>
  ...
  function SonucListele() {
    $("#SonucListe").empty();
    $("#SonucListe").load("ajax/Liste/HakkimizdaListe.php", function (cevap, durum) {
      if (durum == "success") {
  ...
  function SatirSet(e) {
    ...
    ID = SayiTemizle(ID);
    window.location.href = ("HakkimizdaEkle.php?islem=Duzenle&ID=" + ID);
  }
  ...
  $(function () {
    ...
    $("#DetayGorMenu").click(function () {
      window.location.href = ("HakkimizdaEkle.php?islem=Duzenle&ID=" + TiklanilanID);
    });
    $("#SilMenu").click(function () {
      ...
      if (result) {
        ...
        $.ajax({
          url: "ajax/Sil/HakkimizdaSil.php",
          dataType: "JSON",
          type: "POST",
          data: {
            "islem": "sil",
  ...
  function AramaIslemi() {
    ...
    if ($("#TxtArama").val().length <= 0) {
      ...
      PostRequest = $.post("ajax/Liste/HizmetlerListe.php", {
        Like: $("#TxtArama").val()
      }, function (cevap) {
        cevap = jQuery.parseJSON(cevap);
        $("#SonucListe").empty();
