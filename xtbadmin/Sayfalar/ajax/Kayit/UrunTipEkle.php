...
if($_POST){
 ...
 if ($_SERVER['REQUEST_METHOD'] === 'POST') {
	...
	if($islem=="Kayit")
    {
		...
		$save = $db->prepare("INSERT INTO uruntipleri (UrunTipiAdi,UrunTipiAciklama,IsActive) VALUES (?,?,?)");
	...
	if($islem=="Duzenle")
    {
		...
		$save = $db->prepare("UPDATE uruntipleri SET UrunTipiAdi=?,UrunTipiAciklama=?, IsActive=? WHERE ID=?");
