...
<script>
    ...
    function SonucGoruntule($id) {
        $.ajax({
            url: "/en/ajax/Liste/UrunlerListe.php",
            type: "get",
            data: {
                ID: $id,
            },
            success: function (response) {
                ...
                if (cevap.baslik[0].indexOf("ve") > 0) {
                    ...
                    jQuery("ol.breadcrumb li.kategori a").attr("href", "/en/cozumler.php?id="+cevap.urunkategori2id+"&name="+cevap.urunkategori2slug+"&iliski=urunler");
