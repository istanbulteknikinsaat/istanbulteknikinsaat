  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-sm-4 col-xs-12 col-md-6 urunuyg1">
        <a href="cozumler.php?id=2&name=geosentetik"><img src="images/sektorler/geo.jpg" alt="Geosentetikler"></a>
      </div>
      <div class="col-sm-4 col-xs-12 col-md-6 urunuyg2">
        <a href="/tr/urunuygulamadetay/4/istinat-duvarlari-ve-dik-sevler"><img src="images/sektorler/geoarme.jpg" alt="GeoArme Duvar Uygulamaları"></a>
      </div>
    </div>
  </div>
  <div class="container">
    <div class="row">
      <div class="col-sm-4 col-xs-12 col-md-6 urunuyg3">
        <a href="cozumler.php?id=4&name=yesilcati"><img src="images/sektorler/yesil-cati.jpg" alt="Yeşil Çatı Sistemleri"></a>
      </div>
      <div class="col-sm-4 col-xs-12 col-md-6 urunuyg4">
        <a href="cozumler.php?id=7&name=mermer"><img src="images/sektorler/mermer.jpg" alt="Mermer Ürünleri"></a>
      </div>
    </div>
  </div>
  <div class="container">
    <div class="row">
      <div class="col-sm-4 col-xs-12 col-md-6 urunuyg5">
        <a href="cozumler.php?id=3&name=yapikoruma"><img src="images/sektorler/yapi-koruma.jpg" alt="Yalıtım Ürünleri"></a>
      </div>
      <div class="col-sm-4 col-xs-12 col-md-6 urunuyg6">
        <a href="cozumler.php?id=5&name=yolbakim"><img src="images/sektorler/yol-bakim.jpg" alt="Asfalt Ürünleri"></a>
      </div>
    </div>
  </div>
</div>
...
<div class="container2 text-center">
	<div class="row haberler" style="background-color: #039ee3;    padding: 0px 50px 0px 50px;    margin-left: 0 !important;">
		<div class="main_heading text_align_center mt-10" style="margin-left: 35%; margin-top: 50px; margin-bottom: 15px !important;">
			<h2 style="color: white;" class="haberlerheader">NEWS / ANNOUNCEMENTS</h2>
		</div>
		  <div id="recipeCarousel" class="carousel slide w-100" data-ride="carousel">
              ...
              <a href="news.php?id=<?php echo $row['HaberSlug']; ?>&slug=<?php echo $row['ID']; ?>">
