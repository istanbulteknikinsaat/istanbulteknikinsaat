...
<script>
  ...
  <meta name="description"
    content="Istanbul Teknik is a 100% Turkish capital building material production, sales and solution engineering company established in 1998 to meet the needs of the construction industry in which it operates and to contribute to the country's industry.">
  <!-- site icons -->
        ...
        <div class="row">
          ...
          <div class="col-md-6 right_section_header_top">
            <div class="multi_language">
              <form action="/en/arama.php" style="top:17px; display:inline-block;"
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
            <!-- logo start -->
            <div class="logo"> <a href="/en"><img src="/images/logos/istanbul-teknik-logo.png"
          ...
          <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="menu_side">
              <div id="navbar_menu">
                <ul class="first-ul">
                  <li> <a class="homebtn" href="/en">Home</a>
                  </li>
                  <li> <a class="aboutbtn" style="cursor: context-menu">Corporate</a>
                    <ul>
                      <li><a href="/<?php echo $urlend;?>/about-us.php">About Us</a></li>
                      <li><a href="/<?php echo $urlend;?>/general-manager-message.php">Message from the General Manager</a></li>
                      <li><a href="/<?php echo $urlend;?>/our-history.php">Our History</a></li>
                      <li><a href="/<?php echo $urlend;?>/our-principles.php">Our Principles</a></li>
                      <li><a href="/<?php echo $urlend;?>/our-quality-policy.php">Our Quality Policy</a></li>
                      <li><a href="/<?php echo $urlend;?>/arge.php">R&D Center</a></li>
                      <li><a href="/<?php echo $urlend;?>/human-resources.php">Human Resources</a></li>
                    </ul>
                  </li>
                  <li><a href="#" class="productsbtn">Products</a>
                  <?php
                    ...
                    if ($has_childs === false)
                    {
                      ...
                      $slugkategori=seo2($kategoriAdi);
                        ...
                        if($parent == 0){
                            $cikti=$cikti . "<li class='col-xs-12'><a class='anagrup' href='/".$urlend."/cozumler.php?id=" . $key . "&name=".$slugkategori."&iliski=urunler'> " . $value['name'] ."</a>";  
                        } else {
                  ...
                  ?>
                   ...
                   <li><a class="solutionsbtn" style="cursor: context-menu">Applications</a>
                    <ul>
                      <li><a href="/<?php echo $urlend;?>/cozumler.php?id=2&name=geosynthetic&iliski=uygulamalar">Geosynthetics Applications</a></li>
                      <li><a href="/<?php echo $urlend;?>/cozumler.php?id=3&name=insulation-products&iliski=uygulamalar">Insulation Applications</a></li>
                      <li><a href="/<?php echo $urlend;?>/cozumler.php?id=4&name=green-roof-systems&iliski=uygulamalar">Green Roof Applications</a></li>
                      <li><a href="/<?php echo $urlend;?>/cozumler.php?id=5&name=asphalt-products&iliski=uygulamalar">Asphalt Applications</a></li>
                      <li><a href="/<?php echo $urlend;?>/cozumler.php?id=6&name=concrete-products&iliski=uygulamalar">Concrete Applications</a></li>
                      <li><a href="/<?php echo $urlend;?>/cozumler.php?id=7&name=marble-products&iliski=uygulamalar">Marble Applications</a></li>
                    </ul>
                  </li>
                  <li><a class="sectorbtn" style="cursor: context-menu">Industries</a>
                    <ul>
                      ...
                      while ( $row = mysqli_fetch_array($query) )
                      {
                      if($urlend=='tr'){$sektorname=$row['SektorAdi'];}
                      elseif($urlend=='en'){$sektorname=$row['SektorAdiEN'];}
                      elseif($urlend=='de'){$sektorname=$row['SektorAdiDE'];}

                        $sektorID = $row['id'];
                        $sektorAdi = $row['SektorAdi'];
                        $slugsektor=seo2($sektorAdi);
                        /* href='/".$urlend."/sektorlerdetay.php?id=" . $sektorID . "&slug=".$slugsektor."' */
                        echo "<li><a>" . $sektorname . "</a></li>";
                      }
                    ?>
                    </ul>
                  </li>
                  <li> <a class="refbtn" href="/<?php echo $urlend; ?>/references.php">References</a>
                  </li>
                  <li> <a class="contactbtn" href="/<?php echo $urlend; ?>/contact.php">CONTACT</a>
                  </li>
