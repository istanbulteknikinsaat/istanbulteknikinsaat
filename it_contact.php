        ...
        <div class="full">
          <div class="title-holder">
            <div class="title-holder-cell text-left">
              ...
              <ol class="breadcrumb">
                <li><a href="it_home.php">Home Page</a></li>
      ...
      <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-xs-12">
        <div class="row">
          <div class="full">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 map_section">
              <!-- <div id="map"></div> -->
              <iframe id="map" src="https://www.google.com/maps/d/embed?mid=12yPapVPoR3IM_BggAySyDQ9_Dfk&hl=en" width="640" height="480"></iframe>
            </div>
          </div>
        </div>
      </div>
