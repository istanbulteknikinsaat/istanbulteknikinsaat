...
?>
  ...
  <div id="slider" class="section main_slider">
    <div class="container-fuild">
      <div class="row">
        <ul id="bxslider">
          <li><img src="./images/sliders/fortex-almanyada.jpg"></li>
          <li><img src="./images/sliders/istanbul-teknik-as-buyumeye-devam-ediyor.jpg"></li>
          <li><img
              src="./images/sliders/istanbul-teknik-insaat-kardes-sirketi-asfalt-teknolojileri-ile-sektor-liderligini-devam-ettiriyor.jpg">
          </li>
          <li><img
              src="./images/sliders/kuzey-sofya-cevre-yolu-projesi-hipercell-ve-hiprene-ile-asinmalara-karsi-dayanikli.jpg">
          </li>
          <li><img src="./images/sliders/prima-bant-ailesine-yeni-urunler-katildi.jpg"></li>
        </ul>
      </div>
    </div>
  </div>
                  ...
                  <div class="panel panel-default">
                    <div class="panel-heading">
                      <p class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne"><i
                            class="fa fa-bar-chart" aria-hidden="true"></i> Complete Recovery from Local & External
                          Drive<i class="fa fa-angle-down"></i></a> </p>
                    </div>
                  ...
                  <div class="panel panel-default">
                    <div class="panel-heading">
                      <p class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo"><i
                            class="fa fa-plane"></i> Recovery Photo, Image, Video and Audio<i
                  ...
                  <div class="panel panel-default">
                    <div class="panel-heading">
                      <p class="panel-title"> <a data-toggle="collapse" data-parent="#accordion"
                          href="#collapseThree"><i class="fa fa-star"></i> Mobile Phone Recovery<i
                            class="fa fa-angle-down"></i></a> </p>
                    </div>
