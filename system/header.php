        ...
        <div class="row">
          ...
          <div class="col-md-6 right_section_header_top">
            <div class="multi_language">
              <form action="arama.php" style="top:17px; display:inline-block;"
              ...
              <button class="btn white_btn langbtn dropdown-toggle" type="button" data-toggle="dropdown"
                aria-haspopup="true" aria-expanded="false">Türkçe</button>

              <div class="dropdown-menu">
                <a class="dropdown-item" href="../it_home.php">İngilizce</a>
                <a class="dropdown-item" href="../de/it_startseite.php">Almanca</a>
                <a class="dropdown-item" href="../sp/it_pagina.php">İspanyolca</a>
                <!-- <div class="dropdown-divider"></div> -->
                <a class="dropdown-item" href="../fr/it_daccueil.php">Fransızca</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
            <!-- logo start -->
            <div class="logo"> <a href="anasayfa.php"><img src="../images/logos/istanbul-teknik-logo.png"
                  alt="logo" /></a>
            </div>
            <!-- logo end -->
          </div>
          <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="menu_side">
              <div id="navbar_menu">
                <ul class="first-ul">
                  <li> <a class="homebtn" href="anasayfa.php">Anasayfa</a>
                  </li>
                  <li> <a class="aboutbtn" style="cursor: context-menu">Kurumsal</a>
                    <ul>
                      <li><a href="hakkimizda.php">Hakkımızda</a></li>
                      <li><a href="hakkimizda_kalite_politikamiz.php">Kalite Politikamız</a></li>
                      <li><a href="hakkimizda_vizyonumuz_misyonumuz.php">Vizyonumuz & Misyonumuz</a></li>
                      <li><a href="hakkimizda_ilkelerimiz.php">İlkelerimiz</a></li>
                      <li><a href="hakkimizda_tarihcemiz.php">Tarihçemiz</a></li>
                      <li><a href="hakkimizda_istanbul_teknikliler.php">Istanbul Teknikliler</a></li>
                      <li><a href="hakkimizda_arge.php">Arge</a></li>
                      <li><a href="#">KVKK</a></li>
                    </ul>
                  </li>
                  <li><a class="productsbtn" href="urunler.php">Ürünler</a>
                    <?php
                    ...
                    {
                    $menu_array[$row['id']] = array('id' => $row['id'],'name' => $row['kategoriAdi'],'parent' => $row['pid'], 'resim' => $row['KategoriIkonResim']);
                    }
                    ...
                    if ($has_childs === false)
                    {
                        ...
                        if($parent == 0){
                            $cikti=$cikti . "<li class='col-xs-12'><a class='anagrup' href='cozumler.php?id=" . $key . "'> " . $value['name'] ."</a>";  
                        } else {
                            $cikti=$cikti . "<li class='col-xs-12'><a href='urunler.php?id=" . $key . "'>" . $value['name'] ."</a>";  
                        } 
                  ...
                  <li><a class="solutionsbtn" style="cursor: context-menu">Uygulamalar</a>
                    <ul>
                      <li><a href="cozumler.php?id=2&name=geosentetik">Geosentetik Uygulamaları</a></li>
                      <li><a href="cozumler.php?id=3&name=yapikoruma">Yalıtım Uygulamaları</a></li>
                      <li><a href="cozumler.php?id=4&name=yesilcati">Yeşil Çatı Uygulamaları</a></li>
                      <li><a href="cozumler.php?id=5&name=yolbakim">Asfalt Uygulamaları</a></li>
                      <li><a href="cozumler.php?id=6&name=geoarme">Beton Uygulamaları</a></li>
                      <li><a href="cozumler.php?id=7&name=beton">Mermer Uygulamaları</a></li>
                    </ul>
                  </li>
                  <li><a class="sectorbtn" style="cursor: context-menu">Sektörler</a>
                    <ul>
                      ...
                      while ( $row = mysqli_fetch_array($query) )
                      {
                        ...
                        echo "<li><a href='sektorlerdetay.php?id=" . $sektorID . "'>" . $sektorAdi . "</a></li>";
                      }
                    ?>
                    </ul>
                  </li>
                  ...
                  <li> <a class="refbtn" href="referanslar.php">Referanslar</a>
                  </li>
                  <li> <a class="contactbtn" href="iletisim.php">İLETİŞİM</a>
                  </li>
