                  ...
                  <div class="card-body">
                    <ul class="categary">
                      <li><a href="/tr/cozumler.php?id=2&name=geosentetik&iliski=urunler#chooseRelate"><i
                          ...
                          Ürünleri</a></li>
                      <li><a href="/tr/cozumler.php?id=3&name=yalitim&iliski=urunler#chooseRelate"><i
                      ...
                      <li><a href="/tr/cozumler.php?id=4&name=yesilcati&iliski=urunler#chooseRelate"><i
                          ...
                          Ürünleri</a></li>
                      <li><a href="/tr/cozumler.php?id=5&name=asfalt&iliski=urunler#chooseRelate"><i
                  ...
                  <div class="card-body">
                    <ul class="categary">
                      <li><a href="/tr/cozumler.php?id=2&name=geosentetik&iliski=uygulamalar#chooseRelate"><i
                            class="fa fa-angle-right"></i> Geosentetik
                          Uygulamaları</a></li>
                      <li><a href="/tr/cozumler.php?id=3&name=yalitim&iliski=uygulamalar#chooseRelate"><i
                            class="fa fa-angle-right"></i> Yalıtım
                          Uygulamaları</a></li>
                      <li><a href="/tr/cozumler.php?id=4&name=yesilcati&iliski=uygulamalar#chooseRelate"><i
                            class="fa fa-angle-right"></i> Yeşil Çatı
                          Uygulamaları</a></li>
                      <li><a href="/tr/cozumler.php?id=5&name=asfalt&iliski=uygulamalar#chooseRelate"><i
                            class="fa fa-angle-right"></i> Asfalt
                          Uygulamaları</a></li>
...
<script>
  var id=<?= $ID  ?>;
    ...
    function SonucGoruntule() {
      $.ajax({
        url: "/tr/ajax/Liste/BaglantiliUygulamaDetaySayfasiListe.php",
        type: "get",
        data: {
          ID: id,
        },
