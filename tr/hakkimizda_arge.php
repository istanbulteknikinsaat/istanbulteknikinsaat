    ...
    <div class="row">
      <div class="col-md-12">
        <div class="full">
          ...
          <h2>AR-GE</h2>
              <p class="large">Hazırlanmaktadır.</p>
            <p class="large"><?php 
              $sql = "SELECT icerik FROM kurumsal_yazilar WHERE dil='$lang' and siralama='6'";
              $result = mysqli_query($db, $sql);
              if (mysqli_num_rows($result) > 0) {
                // output data of each row
                while($row = mysqli_fetch_assoc($result)) {
                  echo " icerik: " . $row["icerik"]. "<br>";
                }
              } else {
