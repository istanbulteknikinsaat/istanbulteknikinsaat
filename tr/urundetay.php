...
.my-product-details-header.lefttoright.container {
    max-width: 1500px;
}
div#urundetay {
    padding-left: 50px;
...
<body id="default_theme" class="it_shop_detail">
  ...
  <div class="row"> 
  <div class="my-product-details-header lefttoright container">
                  ...
                  <div class="card-body">
                    <ul class="categary">
                      <li><a href="/tr/cozumler.php?id=2&name=geosentetik&iliski=urunler#chooseRelate"><i class="fa fa-angle-right"></i> Geosentetik
                          Ürünleri</a></li>
                      <li><a href="/tr/cozumler.php?id=3&name=yalitim&iliski=urunler#chooseRelate"><i class="fa fa-angle-right"></i> Yalıtım
                          Ürünleri</a>
                      </li>
                      <li><a href="/tr/cozumler.php?id=4&name=yesilcati&iliski=urunler#chooseRelate"><i class="fa fa-angle-right"></i> Yeşil Çatı
                          Ürünleri</a></li>
                      <li><a href="/tr/cozumler.php?id=5&name=asfalt&iliski=urunler#chooseRelate"><i class="fa fa-angle-right"></i> Asfalt
                          Ürünleri</a>
                      </li>
                  ...
                  <div class="card-body">
                    <ul class="categary">
                      <li><a href="/tr/cozumler.php?id=2&name=geosentetik&iliski=uygulamalar#chooseRelate"><i class="fa fa-angle-right"></i> Geosentetik
                          Uygulamaları</a></li>
                      <li><a href="/tr/cozumler.php?id=3&name=yalitim&iliski=uygulamalar#chooseRelate"><i class="fa fa-angle-right"></i> Yalıtım
                          Uygulamaları</a></li>
                      <li><a href="/tr/cozumler.php?id=4&name=asfalt&iliski=uygulamalar#chooseRelate"><i class="fa fa-angle-right"></i> Yeşil Çatı
                          Uygulamaları</a></li>
    ...
    function SonucGoruntule() {
      $.ajax({
        ...
        success: function (response) {
          ...
          if(cevap.urunkategori2id==null){$("ol.breadcrumb li.kategori2").css('display', 'none')}
          $(".urunbrosuru").css('display', 'none');
          $(".uruntds").css('display', 'none');
          if (cevap.resim[0] !== "") {
            $("#wrapper-dilatasyon").append(cevap.resim[0]);
          }
          if(cevap.baslik==null){
            document.location.href = "/";
          }
          $("title").text(cevap.baslik+" - İstanbul Teknik");
          var icerik =$("#description").text();
          var icerik2=icerik.replaceAll(/\s/g," ");
          $("meta[name='description']").attr("content", icerik2);
        },
        error: function (xhr) {
      ...
      if ($("#sehirler").val() == "0" && $("#ulkedurumu").val() == "Yurtiçi") {
        ...
        $.ajax({
          ...
          success: function (response) {
            ...
            cevap = jQuery.parseJSON(response);
            Swal.fire("Form Başarıyla İletildi", "Doldurmuş olduğunuz form tarafımıza ulaşmıştır.En kısa sürede sizinle irtibat kurulacaktır. ", "success");
