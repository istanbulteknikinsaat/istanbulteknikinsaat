  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-4 col-xs-12 col-md-6 urunuyg5">
        <a href="cozumler.php?id=3&name=yalitim"><img src="images/sektorler/yapi-koruma.jpg" alt="Yalıtım Ürünleri"></a>
      </div>
      <div class="col-sm-4 col-xs-12 col-md-6 urunuyg6">
        <a href="cozumler.php?id=5&name=asfalt"><img src="images/sektorler/yol-bakim.jpg" alt="Asfalt Ürünleri"></a>
      </div>
    </div>
  </div>
</div>
...
<div class="container2 text-center">
	<div class="row haberler" style="background-color: #039ee3;    padding: 0px 50px 0px 50px;    margin-left: 0 !important;">
		<div class="main_heading text_align_center mt-10" style="margin-left: 35%; margin-top: 50px; margin-bottom: 15px !important;">
			<h2 style="color: white;" class="haberlerheader">Haberler / Duyurular</h2>
		</div>
