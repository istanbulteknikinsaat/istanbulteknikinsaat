        ...
        <div class="full">
          <div class="title-holder">
            <div class="title-holder-cell text-left">
              <h1 class="page-title">Vizyonumuz & Misyonumuz</h1>
              <ol class="breadcrumb">
                <li><a href="index.php">Anasayfa</a></li>
                <li class="active">Hakkımızda</li>
                <li class="active">Vizyonumuz & Misyonumuz</li>
              </ol>
            </div>
          </div>
        </div>
...
<div class="section padding_layout_1">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <div class="full">
          <div id="main_xtext" class="main_heading text_align_left">
            <h2>Vizyonumuz & Misyonumuz</h2>
            <p class="large text_align_left"/><?php 
              $sql = "SELECT icerik FROM kurumsal_yazilar WHERE dil='$lang' and siralama='2'";
