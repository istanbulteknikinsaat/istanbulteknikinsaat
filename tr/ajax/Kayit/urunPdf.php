...
if($email !== "" && $username !== "" && $companyname !== "" && $telephone !== "" && $action !== ""){
    ...
    $urunadi = $row["UrunAdi"];
    $ekle = $db->query("INSERT INTO urunpdf (kullaniciAdi, eposta, firmaAdi, telefon,urunadi,ulkedurumu,sehir,gorev,aksiyon) VALUES ('$username','$email','$companyname','$telephone','$urunadi','$ulkedurumu','$sehirler','$gorevname','$action')");
