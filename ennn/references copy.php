<?php
  $title = "References";
  $description = "Kurulduğumuz günden itibaren ‘yaşamı iyileştirmek için’ faaliyetlerimizi sürdürerek; yeşil çatı, ısı ve su yalıtımı, istinat duvarları, zemin iyileştirme, güçlendirme ve stabilizasyon referanslarımızı siz kıymetli ziyaretçileri ile paylaşıyoruz.";
...
?>
    ...
    <div class="referanslar-slider">
         <div class="referanslar-header" style="background-image: url(img/insulation-products-references.jpg);"></div>
         <div class="referanslar-header" style="background-image: url(img/geogreen-green-roof-systems-references.jpg);"></div>
         <div class="referanslar-header" style="background-image: url(img/drainage-board-references.jpg);"></div>
    </div>
        ...
        <div class="referanslar-accordion">
                        ...
                        <h3><div class="wrapper">ForTex Geogrids<span class="icon"></span></div></h3>
...
<?php $refData1 = referansList("Fortex Geogridler"); 
  ...
  ?>
                        ...
                        <h3><div class="wrapper">GeoTeknik<span class="icon"></span></div></h3>
...
<?php $refData1 = referansList("GeoTeknik"); 
  ...
  ?>
                        ...
                        <h3><div class="wrapper">GeoArme<span class="icon"></span></div></h3>
...
<?php $refData1 = referansList("GeoArme"); 
  ...
  ?>
                        ...
                        <h3><div class="wrapper">GeoSeal<span class="icon"></span></div></h3>
...
<?php $refData1 = referansList("GeoSeal"); 
  ...
  ?>
        ...
        <h3><div class="wrapper">TeraGrip Soyulma Önleyiciler<span class="icon"></span></div></h3>
        <div class="accordion-content">
                   <div class="wrapper">
                <ul class="rlist">
                <li class="rlist-header">
                <?php $refData1 = referansList("TeraGrip Soyulma Önleyiciler"); 
        ...
        <h3><div class="wrapper">Asfalt Ürünleri<span class="icon"></span></div></h3>
        <div class="accordion-content">
                   <div class="wrapper">
                <ul class="rlist">
                <li class="rlist-header"> 
                <?php $refData1 = referansList("Asfalt Ürünleri"); 
                     echo '<div class="rlist-header-col-1">'.$refData1[0][0].'</div><div class="rlist-header-col-2">&nbsp;</div> <div class="rlist-header-col-2">&nbsp;</div><div class="rlist-header-col-2">Kullanılan Ürün</div>'; ?>
                </li>
                  <?php             
                   for ($x = 1; $x <= sizeof($refData1)-1; $x++) {
                            echo  '<li class="rlist-row"><div class="rlist-col-1">'.$refData1[$x][0].'</div>  <div class="rlist-col-2">'.$refData1[$x][1].'</div>  <div class="rlist-col-2">'.$refData1[$x][2].'</div>  <div class="rlist-col-2">'.$refData1[$x][3].'</div></li>';
                  ...
                  ?>
                        ...
                        <h3><div class="wrapper">TrioTex Çatı ve Cephe Örtüleri<span class="icon"></span></div></h3>
...
<?php $refData1 = referansList("TrioTex Çatı ve Cephe Örtüleri"); 
  ...
  ?>
                        ...
                        <h3><div class="wrapper">Yeşil Çatı Sistemleri<span class="icon"></span></div></h3>
