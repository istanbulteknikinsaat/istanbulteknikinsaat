<?php
  ...
  $title = "İzoTeknik Non-Woven Geotextiles";
  $description = "İzoTeknikNon-Woven Geotextiles are non-woven textile product in dark color which is manufactured by the method of knitting the pure polyester-based fibers much thinner than millimeter and executing heat treatment.";
  ...
  $countDir =  substr_count($_SERVER['PHP_SELF'], '/') - 1;  
  $dirPosition = ''; for ($x = 1; $x <= $countDir; $x++) { $dirPosition .= "../"; }
...
?>
 ...
 <section class="product-page">
  <?php 
     ...
     include $dirPosition.'product-header.php'; 
...
<!-- PRODUCT PAGE START -->
    ...
    <p><b>İzoTeknikNon-Woven Geotextiles</b> are non-woven textile product in dark color which is manufactured by the method of knitting the pure polyester-based fibers much thinner than millimeter and executing heat treatment.</p>
...
<ul class="subpage-full-list">
  ...
  <li>It protects the geo-membranes used on open fields against any tear or impairment arising from puncture and excessive friction.</li>
...
<h3>Advantages</h3>
<ul class="subpage-full-list">
    <li>It is produced by polyester fiber..</li>
