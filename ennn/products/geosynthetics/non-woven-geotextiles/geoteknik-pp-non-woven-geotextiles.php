<?php
  ...
  $title = "GeoTeknik PP Non-Woven Geotextiles";
  $description = "GeoTeknik PP Non-Woven Geotextiles are non-woven textile product in white color which is manufactured by the method of knitting the pure polypropylene-based fibers much thinner than millimeter.";
...
<!-- PRODUCT PAGE START -->
    ...
    <p><b>GeoTeknik PP Non-Woven Geotextiles</b> are non-woven textile product in white color which is manufactured by the method of knitting the pure polypropylene-based fibers much thinner than millimeter.</p>
...
<b>GeoTeknik PP Non-Woven Geotextiles</b> which are recommended as filtering and bearing material for control and direction of the water effectively is used in the following areas.
</p>
...
<li>In coastal buildings, it is used as filter and bedding material in order to prevent the displacement of filler due to the wave action. It effectively separates the coarse and fine filter material used in filler, prevents the fine material to join into coarse material by means of the suction force resulting from wave movements.</li>
</ul>
...
<h3>Advantages</h3>
<ul class="subpage-full-list">
      <li>It is produced by use of pure polypropylene fiber.</li>
