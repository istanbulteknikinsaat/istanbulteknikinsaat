<?php
  ...
  $title = "Epoxİstt Mega BlockGel";
  $description = "Epoxİstt Mega BlockGel, In general, single layer implementation is sufficient with its specially developed formulation. It is produced in two different types for cold climates and warm climates depending on the regional weather conditions.";
...
<h3>Mixture Ratio</h3>
<p>
4 Units Epoxİstt Mega Epoxy Block Filling Gel<br>
1 Unit Epoxİstt Mega Block Gel Hardener
</p>
...
<h3>Usage</h3>
<ul class="subpage-full-list">
  <li>The amount of block filling gel to be used consists of 4 parts of gel and 1 part of hardener. The components, should be mixed homogenously on the surfaces, preferably on the shiny polished surfaces such as tiles, at least 60 seconds and the product should be used when it comes to transparent consistency.</li>
  <li>Using materials like metal spatula or trowel is recommended for implementation.</li>
</ul>


<h3>Storage</h3>
<p>The product can be stored airtight in the moisture-free and out of exposure to direct sunlight environment at 15-25 °C for one year.</p>
