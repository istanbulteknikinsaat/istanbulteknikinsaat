<?php
  ...
  $title = "Epoxİstt Ultra Plate Gel";
  $description = "Epoxİstt Ultra Plate Gel, It is produced in two different types for cold climates and warm climates depending on the regional weather conditions.";
...
<h3>Mixture Ratio</h3>
<p>
  4 Units Epoxİstt Ultra Epoxy Block Filling Gel <br>
  1 Unit Epoxİstt Ultra Gel Hardener
...
<h3>Usage</h3>
<p>The amount of filling gel to be used should be taken from 4 parts of A and 1 part of B components and should be mixed homogenously on the surfaces, preferably on the shiny polished surfaces such as tiles, at least 60 seconds and the product should be applied when it comes to transparent consistency.
</p>
