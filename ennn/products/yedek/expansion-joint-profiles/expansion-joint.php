...
if (file_exists($imageFilePos)) {
        ...
        if ($kapak) {
             ...
             $imageFilePos = $dirPosition.'img/expansion-joint-profiles/'.$breadcrumpLink3.'-'.$product['name'].'-technical-drawing.jpg';
                ...
                if (file_exists($imageFilePos)) {
                     $productImageFile = '<img src="img/expansion-joint-profiles/'.$breadcrumpLink3.'-'.$product['name'].'-technical-drawing.jpg" alt="'.$title.'Technical Drawing">';
              ...
              if (file_exists($imageFilePos3)) {
                  ...
                  $productImageFile = '<img src="img/expansion-joint-profiles/'.$breadcrumpLink3.'-'.$breadcrumpLink2.'-'.$product['name'].'-technical-drawing.jpg" alt="'.$title.'Technical Drawing">';
