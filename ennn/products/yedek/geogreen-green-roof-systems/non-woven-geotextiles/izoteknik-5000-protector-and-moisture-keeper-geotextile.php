<?php
  ...
  $title = "İzoTeknik 5000 Protector and Moisture Keeper Geotextile";
  $description = "İzoTeknik 5000 Protector and Moisture Keeper Geotextile, is a non-woven textile product which is manufactured in dark color by method of knitting of pure polyester-based fibers much thinner than a millimeter and implementation of heat treatment for protection.";
...
<ul class="subpage-full-list">
 ...
 <li>It protects the geo-membranes used on open lands against any tear or impairment arising from puncture and excessive friction.</li>
  <li>The geotextile brought on the treated surface in roll should be spread on the stretch for complete contact with the surface. In order to prevent slippage of the geotextile during the filling process, it should be applied under the previous geotextile with an overlap of 20 cm minimum.
</li>
</ul>
