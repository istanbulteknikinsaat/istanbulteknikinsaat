<?php
  ...
  $title = "Epoxİstt Ultra Marble Reinforcing Resin";
  $description = "Epoxİstt Ultra Marble Reinforcing Resin, It does not lose its shine in polishing and finishing processes. Light odor, It has fine structure with low viscosity-fast flow.";
...
<ul class="subpage-full-list">
      ...
      <li>Light odor.</li>
      <li>It has fine structure with low viscosity-fast flow.</li>
...
<ul class="subpage-full-list">
    ...
    <li>Surface temperatureshould be minimum 20 °C.</li>
</ul>


<h3>Usage</h3>
<p>The amount of strengthening liquid epoxy to be used should be taken from the package; resin and hardener components should be mixed with spatula or stick homogenously for at least 90 seconds in a plastic container and the product should be used when it comes to transparent consistency.</p>

<h3>Storage</h3>
<p>The product can be stored airtight in the moisture-free storage out of reach of direct sunlight at 15-25 °C for one year.</p>
