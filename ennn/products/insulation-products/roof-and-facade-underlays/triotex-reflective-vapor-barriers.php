<?php
  ...
  $title = "TrioTex Reflective Vapor Barriers";
  $description = "TrioTex Reflective Vapor Barriers, is a reflective three layer vapor barrier underlays reflecting heat energy and providing extra insulation. It consists of polyethylene foil, polypropylene bearing mesh and aluminized polyethylene layers. With TrioTex R-FX Plus having the self-adhesive overlapping parts, easy application and price advantage are provided. ";
...
<!-- PRODUCT PAGE START -->
    ...
    <p><b><?php echo $title ?>,</b> TrioTex Reflective Vapor Barriers, is a reflective three layer vapor barrier underlays reflecting heat energy and providing extra insulation. It consists of polyethylene foil, polypropylene bearing mesh and aluminized polyethylene layers. With <b>TrioTex R-FX Plus</b> having the self-adhesive overlapping parts, easy application and price advantage are provided. </p>



<h3>Fields of Application and Usage</h3>
<p>While it may vary according to vertical and horizontal applications for roof and facade it should be laid by being stretched with at least 10 cm overlapping and overlaps should be surely sealed. It should be fasten on the surface with mastic at the starting and end of the covering application. If the product is not PLUS type, the foil tapes such as TrioTex DS 38 tape should be applied to underlay overlaps in between or TrioTex SP AL folio tape should be applied to the overlaps top. Repairing of small damages or rips is made by patching with a product part or with a folio tape. Rolls have underlay surface of 75 m2 and area to be covered is 70 m2 at ideal conditions. The surface of product should be protected from dust and water once it is unpacked. Application of tapes and mastic requires clean surfaces.
</p>
...
<h3>Advantages</h3>
<ul class="subpage-full-list">
    <li>It is resistant to water vapor.</li>
    ...
    <li>High strength and ability to use for a long time with single application, makes TrioTex Vapor Barrier Underlays an environment friendly product.</li> 
</ul>
