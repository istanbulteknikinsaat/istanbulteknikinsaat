<?php
  ...
  $description = "TekDrain Geo 10/400 (400 kN/m²) Drainage Board prevents blockage of waste gap around the blister with its integrated geotextile cover. It has high drainage capacity. The air gap between the blisters enables safe drainage of flowing water and protection of the structure. Drainage board has high compression strength and important technical specifications for tunnel and infrastructure applications. TekDrain Geo 10/400 Drainage Board is preferred for sub roads, parking lots, bridges and garages for its high drainage performance.";
